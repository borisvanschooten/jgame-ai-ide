/*@webcogs_build 0.6.0 openai-gpt-5.4 2026-05-13T20:20:41.869Z
...
@webcogs_user_prompt
Write a module that displays in main, which shows an iframe that loads the URL provided by getSpriteEditor().
@webcogs_end_prompt_section*/
export class SpriteEditorFrame {
  constructor(core, params) {
    ...
    this.root = this.core.mount(
      'main',
      `
        <div class="sprite-editor-frame-container">
          <iframe class="sprite-editor-frame" title="Sprite Editor"></iframe>
        </div>
      `,
      `
        .sprite-editor-frame-container {
          width: 100%;
          height: 100%;
          min-height: 80vh;
    ...
    this.iframe = this.root.querySelector('.sprite-editor-frame');
    if (this.iframe && this.core && typeof this.core.getSpriteEditor === 'function') {
      this.iframe.src = this.core.getSpriteEditor();
    }
  }
}
