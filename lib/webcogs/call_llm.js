...
async function callLLM(client,messages,tools,aifnPrefix,available_functions,modelName="gpt-5.4",nrTries=20,showToolCallsElem="response",truncateResult=2000,tool_choice="auto") {
	var outputString = ""
	while (nrTries >= 0) {
		nrTries--
		var alltools = tools
